...
![Sublime Text3字体图片](http://img.my.csdn.net/uploads/201311/17/1384620907_7247.jpg "Sublime Text3字体图片")。
...
* [下载我的快捷键设置](http://pan.baidu.com/s/148Cfn "我的快捷键设置")。
* [下载我的参数配置](http://pan.baidu.com/s/1xhcrq "我的参数配置")。
